...
17. **Severity Levels** - Error vs warning violations for flexible enforcement
18. **Dependency Graph Visualization** - Interactive HTML and Graphviz DOT format graphs
